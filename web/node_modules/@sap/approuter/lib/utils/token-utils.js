...
async function getClientCredentialsTokenByTenant(correlationId, tenant, credentials, zoneInfo, cb) {
  ...
  try {
    ...
    return tokenResponseOptions.errorMessage
      ? cb(new Error(tokenResponseOptions.errorMessage))
    ...
    return cb(new Error(tokenResponseOptions.errorMessage || err.message));
  }
}
